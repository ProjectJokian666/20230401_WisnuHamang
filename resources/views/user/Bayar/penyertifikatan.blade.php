...
<div class="container">
    <div class="card shadow">
        <h3 class="card-header">PEMBAYARAN PENYERTIFIKATAN</h3>
        <div class="card-body">
            <form action="{{url('users/penyertifikatans/bayar/'.$id)}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="mt-2 ml-5">
                ...
                <div class="mt-5 mb-5 ml-5">
                    ...
                    <a href="{{url('users/penyertifikatans')}}" class="btn btn-info col-2">Kembali</a>
                </div>
            </form>
        </div>
    </div>
