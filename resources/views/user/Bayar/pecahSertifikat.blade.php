...
<div class="container">
    <div class="card shadow">
        ...
        <div class="card-body">
            <form action="{{url('users/pecahSertifikats/bayar/'.$id)}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="mt-2 ml-5">
                ...
                <div class="mt-5 mb-5 ml-5">
                    ...
                    <a href="{{url('users/pecahSertifikats')}}" class="btn btn-info col-2">Kembali</a>
                </div>
            </form>
        </div>
    </div>
