...
<div class="container col-lg-6">
    <div class="card shadow">
        ...
        <div class="card-body">
            <form action="/users/jualBelis/add/" enctype="multipart/form-data" method="post">
                @csrf
                <div class=" row mb-4">
                    <div class="col-md-4">
                ...
                <div class="mb-2">
                    ...
                    <input type="file" class="form-control @error('fcKtpPenjual') is-invalid @enderror" name="fcKtpPenjual" required>
                    @error('fcKtpPenjual')
                ...
                <div class="mb-2">
                    ...
                    <input type="file" class="form-control @error('fcKtpPembeli') is-invalid @enderror" name="fcKtpPembeli" required>
                    @error('fcKtpPembeli')
                    <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
                <div class="mb-2">
                    ...
                    <input type="file" class="form-control @error('fcKkPenjual') is-invalid @enderror" name="fcKkPenjual" required>
                    @error('fcKkPenjual')
                    <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
                <div class="mb-2">
                    ...
                    <input type="file" class="form-control @error('fcKkPembeli') is-invalid @enderror" name="fcKkPembeli" required>
                    @error('fcKkPembeli')
                    <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
                <div class="mb-2">
                    ...
                    <input type="file" class="form-control @error('bukuNikahPenjual') is-invalid @enderror" name="bukuNikahPenjual">
                    @error('bukuNikahPenjual')
                    <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
                <div class="mb-2">
                    <label for="">Fotocopy Sertifikat</label>
                    <input type="file" class="form-control @error('fcSertifikat') is-invalid @enderror" name="fcSertifikat" required>
                    @error('fcSertifikat')
                    <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-hover" id="dataTable">
                    ...
                    <tbody align="left">
                        @foreach ($data['jual_belis'] as $data)
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <a href="{{url('/users/jualBelis/bayar/'.$data->id)}}" class="btn btn-sm btn-success">PEMBAYARAN</a>
