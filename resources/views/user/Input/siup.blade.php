...
<div class="container col-lg-6">
    <div class="card shadow">
        ...
        <div class="card-body">
            <form action="/users/siups/add/" enctype="multipart/form-data" method="post">
                @csrf
                <div class=" row mb-4">
                    <div class="col-md-4">
                    ...
                    <tbody align="left">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <a href="{{url('/users/siups/bayar/'.$data->id)}}" class="btn btn-sm btn-success">PEMBAYARAN</a>
