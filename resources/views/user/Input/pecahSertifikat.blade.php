...
<div class="container col-lg-6">
    <div class="card shadow">
        ...
        <div class="card-body">
            <form action="/users/pecahSertifikats/add/" enctype="multipart/form-data" method="post">
                @csrf
                <div class=" row mb-4">
                    <div class="col-md-4">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-hover" id="dataTable">
                    ...
                    <tbody align="left">
                        @foreach ($data['pecah_sertifikats'] as $data)
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <a href="{{url('/users/pecahSertifikats/bayar/'.$data->id)}}" class="btn btn-sm btn-success">PEMBAYARAN</a>
