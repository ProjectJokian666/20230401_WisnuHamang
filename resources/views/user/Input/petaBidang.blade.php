...
<div class="container col-lg-6">
    <div class="card shadow">
        ...
        <div class="card-body">
            <form action="/userspetaBidangs/add/" enctype="multipart/form-data" method="post">
                @csrf
                <div class=" row mb-4">
                    <div class="col-md-4">
                ...
                <div class="mb-2">
                    ...
                    <input type="file" class="form-control @error('fotoPatok') is-invalid @enderror" name="fotoPatok" required>
                    @error('fotoPatok')
                    <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-hover" id="dataTable">
                    ...
                    <tbody align="left">
                        @foreach ($data['peta_bidangs'] as $data)
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <a href="{{url('/users/petaBidangs/bayar/'.$data->id)}}" class="btn btn-sm btn-success">PEMBAYARAN</a>
