    ...
    <div class="card shadow">
        ...
        <div class="card-body">
            <table class="table table-hover" >
                <div class="row mb-5">
                    <div class="col-md-2">
                        <form action="/users/pecahSertifikats/batal/{{$datax->id}}" method="post">
                            @method('delete')
                            @csrf
                    ...
                    <div class="col-md-2">
                        <form action="/users/pecahSertifikats/selesai/{{$datax->id}}" method="post">
                            @csrf
                ...
                <tbody align="center">
                  <tr>
                    <td>Fotocopy KTP</td>
                    <td>{{$datax->fcKtp}}</td>
                    <td><a href="{{asset('Pecah_Sertifikat/KTP/'.$datax->fcKtp)}}" target="blank" class="btn btn-info d-block">Lihat</a></td>
                  </tr>
                  <tr>
                    <td>Fotocopy KK</td>
                    <td>{{$datax->fcKk}}</td>
                    <td><a href="{{asset('Pecah_Sertifikat/KK/'.$datax->fcKk)}}" target="blank" class="btn btn-info d-block">Lihat</a></td>
                  </tr>
                  <tr>
                    <td>Sertifikat Asli</td>
                    <td>{{$datax->sertifikatAsli}}</td>
                    <td><a href="{{asset('Pecah_Sertifikat/Sertifikat_Asli/'.$datax->sertifikatAsli)}}" target="blank" class="btn btn-info d-block">Lihat</a></td>
                  </tr>
                  <tr>
                    <td>PBB Terbaru</td>
                    <td>{{$datax->pbbTerbaru}}</td>
                    <td><a href="{{asset('Pecah_Sertifikat/PBB/'.$datax->pbbTerbaru)}}" target="blank" class="btn btn-info d-block">Lihat</a></td>
                  </tr>
                  <tr>
                    <td>Foto Lokasi</td>
                    <td>{{$datax->fotoLokasi}}</td>
                    <td><a href="{{asset('Pecah_Sertifikat/Lokasi/'.$datax->fotoLokasi)}}" target="blank" class="btn btn-info d-block">Lihat</a></td>
                  </tr>
                </tbody>
            </table>
        </div>
