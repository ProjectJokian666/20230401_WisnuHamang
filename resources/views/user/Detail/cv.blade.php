    ...
    <div class="card shadow">
        ...
        <div class="card-body">
            <table class="table table-hover" >
                <div class="row mb-5">
                    <div class="col-md-2">
                        <form action="/users/cvs/batal/{{$datax->id}}" method="post">
                            @method('delete')
                            @csrf
                    ...
                    <div class="col-md-2">
                        <form action="/users/cvs/selesai/{{$datax->id}}" method="post">
                            @csrf
                ...
                <tbody align="center">
                  <tr>
                    ...
                    <td><a href="{{asset('CV/KTP_Pengurus/'.$datax->fcKtpPengurus1)}}" target="blank" class="btn btn-info d-block">Lihat</a></td>
                  </tr>
                  <tr>
                    <td>Fotocopy KTP Pengurus 2</td>
                    <td>{{$datax->fcKtpPengurus2}}</td>
                    <td><a href="{{asset('CV/KTP_Pengurus/'.$datax->fcKtpPengurus2)}}" target="blank" class="btn btn-info d-block">Lihat</a></td>
                  </tr>
                  <tr>
                    <td>Fotocopy KK Pengurus 1</td>
                    <td>{{$datax->fcKKPengurus1}}</td>
                    <td><a href="{{asset('CV/KK_Pengurus/'.$datax->fcKKPengurus1)}}" target="blank" class="btn btn-info d-block">Lihat</a></td>
                  </tr>
                  <tr>
                    <td>Fotocopy KK Pengurus 2</td>
                    <td>{{$datax->fcKKPengurus2}}</td>
                    <td><a href="{{asset('CV/KK_Pengurus/'.$datax->fcKKPengurus2)}}" target="blank" class="btn btn-info d-block">Lihat</a></td>
                  </tr>
                  <tr>
                    <td>NPWP</td>
                    <td>{{$datax->npwp}}</td>
                    <td><a href="{{asset('CV/NPWP/'.$datax->npwp)}}" target="blank" class="btn btn-info d-block">Lihat</a></td>
                  </tr>
                </tbody>
            </table>
        </div>
