...
<div class="container">
    <div class="card shadow">
        <h3 class="card-header">Edit Status Penyertifikatan</h3>
        <div class="card-body">
            <form action="/updatePenyertifikatan/{{$data->id}}" method="POST">
            @method('patch')
            @csrf
            ...
            <a href="/penyertifikatans" class="btn btn-info col-2">Kembali</a>
            </div>
        </form>
        </div>
    </div>
