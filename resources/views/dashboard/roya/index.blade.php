...
<div class="row">
    <div class="col-lg-12">
        <div class="card shadow ">
            <div class="card-body">
                <h3 class=" font-weight-bold text-primary text-center">DATA ROYA</h3>
                    ...
                    <table class="table table-hover" id="dataTable">
                        ...
                        <tbody align="left">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{url('detailRoya',$data->id)}}" class="btn btn-sm btn-info">Detail</a>
                                    <a href="{{url('editRoya',$data->id)}}" class="btn btn-sm btn-warning">Edit</a>
                                    ...
                                    <a href="{{url('bayarRoya',$data->id)}}" class="btn btn-sm btn-success">Pembayaran</a>
                                    @elseif($data->ket == 'dp' && $data->pembayaran == 'sudah')
                                    <a href="{{url('bayarRoya',$data->id)}}" class="btn btn-sm btn-success">DP</a>
                                    ...
                                    <a href="{{url('bayarRoyaA',$data->id)}}" class="btn btn-sm btn-success">Pembayaran</a>
                                    @elseif($data->pembayaran=='sudah' && $data->ket=='dp')
                                    <a href="{{url('bayarRoyaA',$data->id)}}" class="btn btn-sm btn-success">DP</a>
                                    @elseif($data->pembayaran=='konfirm' && $data->ket=='lunas')
                                    <span class="badge badge-primary p-2">LUNAS</span>
                                    @endif
                                    @endif  

                                    <form action="{{url('hapusRoya',$data->id)}}" method="post">
                                        @method('delete')
                                        @csrf
    ...
    <div class="modal-dialog modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{url('tambahRoya')}}" enctype="multipart/form-data" method="post">
                    @csrf
                    <div class="mb-2">
                    ...
                    <div class="mb-2">
                        ...
                        <input type="file" class="form-control" name="fcKtp" required>
                    </div>
                    <div class="mb-2">
                        <label for="">Fotocopy KK</label>
                        <input type="file" class="form-control" name="fcKk" required>
                    </div>
                    <div class="mb-2">
                        <label for="">Surat Permohonan Dari Bank</label>
                        <input type="file" class="form-control" name="suratPermohonan" required>
                    </div>
                    <div class="mb-2">
                        <label for="">Surat Lunas Dari Bank</label>
                        <input type="file" class="form-control" name="suratLunas" required>
                    </div>
                    <div class="mb-2">
                        <label for="">KTP Petugas Bank</label>
                        <input type="file" class="form-control" name="ktpPetugas" required>
                    </div>
                    <div class="mb-2">
