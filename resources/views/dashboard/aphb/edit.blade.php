...
<div class="container">
    <div class="card shadow">
        ...
        <div class="card-body">
            <form action="/updateAPHB/{{$data->id}}" method="POST">
            @method('patch')
            @csrf
            ...
            <div class="mt-2 ml-5">
                ...
                <input type="text" class="form-control col-lg-8" value="{{$data->nik}}" name="nikk" readonly>
            </div>
            <div class="mt-2 ml-5">
            ...
            <a href="/aphbs" class="btn btn-info col-2">Kembali</a>
            </div>
        </form>
        </div>
    </div>
