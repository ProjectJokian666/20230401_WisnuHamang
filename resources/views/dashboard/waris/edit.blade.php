...
<div class="container">
    <div class="card shadow">
        <h3 class="card-header">Edit Status APHB</h3>
        <div class="card-body">
            <form action="/updateWaris/{{$data->id}}" method="POST">
            @method('patch')
            @csrf
            ...
            <div class="mt-2 ml-5">
                ...
                <input type="text" class="form-control col-lg-8" value="{{$data->nik}}" name="tanggal" readonly>
            </div>
            <div class="mt-2 ml-5">
            ...
            <a href="/wariss" class="btn btn-info col-2">Kembali</a>
            </div>
        </form>
        </div>
    </div>
