...
<div class="row">
    <div class="col-lg-12">
        <div class="card shadow ">
            <div class="card-body">
                <h3 class=" font-weight-bold text-primary text-center">DATA WARIS</h3>
                    ...
                    <table class="table table-hover" id="dataTable">
                        ...
                        <tbody align="left">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{url('detailWaris',$data->id)}}" class="btn btn-sm btn-info">Detail</a>
                                    <a href="{{url('editWaris',$data->id)}}" class="btn btn-sm btn-warning">Edit</a>
                                    ...
                                    <a href="{{url('bayarWaris',$data->id)}}" class="btn btn-sm btn-success">Pembayaran</a>
                                    @elseif($data->ket == 'dp' && $data->pembayaran == 'sudah')
                                    <a href="{{url('bayarWaris',$data->id)}}" class="btn btn-sm btn-success">DP</a>
                                    ...
                                    <a href="{{url('bayarWarisA',$data->id)}}" class="btn btn-sm btn-success">Pembayaran</a>
                                    @elseif($data->pembayaran=='sudah' && $data->ket=='dp')
                                    <a href="{{url('bayarWarisA',$data->id)}}" class="btn btn-sm btn-success">DP</a>
                                    @elseif($data->pembayaran=='konfirm' && $data->ket=='lunas')
                                    <span class="badge badge-primary p-2">LUNAS</span>
                                    @endif
                                    @endif  

                                    <form action="{{url('hapusWaris',$data->id)}}" method="post">
                                        @method('delete')
                                        @csrf
