...
<div class="row">
    <div class="col-lg-12">
        <div class="card shadow">
            <div class="card-body">
                <h3 class=" font-weight-bold text-primary text-center">DATA HIBAH</h3>
                    ...
                    <table class="table table-hover" id="dataTable">
                        ...
                        <tbody align="left">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{url('detailHibah',$data->id)}}" class="btn btn-sm btn-info">Detail</a>
                                    <a href="{{url('editHibah',$data->id)}}" class="btn btn-sm btn-warning">Edit</a>
                                    ...
                                    <a href="{{url('bayarHibah',$data->id)}}" class="btn btn-sm btn-success">Pembayaran</a>
                                    @elseif($data->ket == 'dp' && $data->pembayaran == 'sudah')
                                    <a href="{{url('bayarHibah',$data->id)}}" class="btn btn-sm btn-success">DP</a>
                                    ...
                                    <a href="{{url('bayarHibahA',$data->id)}}" class="btn btn-sm btn-success">Pembayaran</a>
                                    @elseif($data->pembayaran=='sudah' && $data->ket=='dp')
                                    <a href="{{url('bayarHibahA',$data->id)}}" class="btn btn-sm btn-success">DP</a>
                                    @elseif($data->pembayaran=='konfirm' && $data->ket=='lunas')
                                    <span class="badge badge-primary p-2">LUNAS</span>
                                    @endif
                                    @endif

                                    <form action="{{url('hapusHibah',$data->id)}}" method="post">
                                        @method('delete')
                                        @csrf
    ...
    <div class="modal-dialog modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{url('tambahHibah')}}" enctype="multipart/form-data" method="post">
                    @csrf
                    <div class="mb-2">
                    ...
                    <div class="mb-2">
                        ...
                        <input type="file" class="form-control" name="fcKtpPenerima" required>
                    </div>
                    <div class="mb-2">
                        <label for="">Fotocopy KTP Pemberi</label>
                        <input type="file" class="form-control" name="fcKtpPemberi" required>
                    </div>
                    <div class="mb-2">
                        <label for="">Fotocopy KK Penerima</label>
                        <input type="file" class="form-control" name="fcKkPenerima" required>
                    </div>
                    <div class="mb-2">
                        <label for="">Fotocopy KK Pemberi</label>
                        <input type="file" class="form-control" name="fcKkPemberi" required>
                    </div>
                    <div class="mb-2">
                        <label for="">Buku Nikah Pemberi</label>
                        <input type="file" class="form-control" name="bukuNikahPemberi">
                    </div>
                    <div class="mb-2">
