...
<div class="container">
    <div class="card shadow">
        <h3 class="card-header">PEMBAYARAN SIUP</h3>
        <div class="card-body">
            <form action="{{url('bayarSiupA/'.$data['id'])}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="mt-2 ml-5">
                ...
                <div class="mt-5 mb-5 ml-5">
                    ...
                    <a href="{{url('siups')}}" class="btn btn-info col-2">Kembali</a>
                </div>
            </form>
        </div>
    </div>
        ...
        <div class="card-body">
            <form>
                <div class="mt-2 ml-5 row">
                    @if(asset('/SIUP/BAYAR/'.$data->bukti))
                    <img class="col-lg-12" src="{{asset('/SIUP/BAYAR/'.$data->bukti)}}" alt="{{$data->bayar}}">
                    @endif
                </div>
            </form>
        </div>
